module.exports = {
  ...
  objects: [
    ...
    { prototypes: ["handScreen"], y:   0, visionWhitelist: ["red"  ], backgroundColor: "rgba(255,0,0,0.4)", labelPlayerName: "red",   },
    { prototypes: ["handScreen"], y: 700, visionWhitelist: ["black"], backgroundColor: "rgba(0,0,0,0.4)",   labelPlayerName: "black", },
  ],
};
